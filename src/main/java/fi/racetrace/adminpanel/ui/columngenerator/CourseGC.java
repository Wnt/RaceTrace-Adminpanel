...
public class CourseGC implements ColumnGenerator {
	...
	public Object generateCell(Table source, Object itemId, Object columnId) {
		...
		hl.addComponent(new Coursepointer(latestUpdate.getCourse()));
		hl.addComponent(new Label(latestUpdate.getCourse() + "°"));
		return hl;
	}
